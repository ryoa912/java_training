...
public class MyField implements Comparable<MyField> {
	...
	public MyField(Field field, MyInstance element) {
		this.field = field;
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		return obj instanceof MyField ? getName().equals(
				((MyField) obj).getName()) : toString().equals(
				obj.toString());
	}
	...
	@Override
	public int compareTo(MyField o) {
